...
namespace TeamWebApplication.Migrations
{
    ...
    [Migration("20231127112633_Ratings")]
            ...
            modelBuilder.Entity("TeamWebApplication.Models.Comment", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CourseId = 10000,
                            CreationTime = new DateTime(2023, 11, 27, 13, 26, 33, 288, DateTimeKind.Local).AddTicks(1724),
                        ...
                        new
                        {
                            ...
                            CourseId = 10001,
                            CreationTime = new DateTime(2023, 11, 27, 13, 26, 33, 288, DateTimeKind.Local).AddTicks(1728),
                            UserComment = "good",
                            UserId = 20002
                        },
                        new
                        {
                            ...
                            CommentatorSurname = "Stuknaite",
                            CourseId = 10000,
                            CreationTime = new DateTime(2023, 11, 27, 13, 26, 33, 288, DateTimeKind.Local).AddTicks(1730),
                            UserComment = "Cool",
                            UserId = 20002
                        });
                });
            ...
            modelBuilder.Entity("TeamWebApplication.Models.Course", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            CourseId = 10000,
                            CreationDate = new DateTime(2023, 11, 27, 13, 26, 33, 286, DateTimeKind.Local).AddTicks(6651),
                        ...
                        {
                            CourseId = 10001,
                            CreationDate = new DateTime(2023, 11, 27, 13, 26, 33, 286, DateTimeKind.Local).AddTicks(6682),
                        ...
                        {
                            CourseId = 10002,
                            CreationDate = new DateTime(2023, 11, 27, 13, 26, 33, 286, DateTimeKind.Local).AddTicks(6684),
            ...
            modelBuilder.Entity("TeamWebApplication.Models.FilePost", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            PostId = 30003,
                            CourseId = 10001,
                            CreationDate = new DateTime(2023, 11, 27, 13, 26, 33, 288, DateTimeKind.Local).AddTicks(1706),
                            IsVisible = true,
                            Name = "File",
                            PostType = 0,
            ...
            modelBuilder.Entity("TeamWebApplication.Models.TextPost", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            PostId = 30000,
                            CourseId = 10000,
                            CreationDate = new DateTime(2023, 11, 27, 13, 26, 33, 288, DateTimeKind.Local).AddTicks(1669),
                            IsVisible = true,
                            Name = "Introduction",
                            PostType = 0,
                        ...
                        new
                        {
                            PostId = 30001,
                            CourseId = 10002,
                            CreationDate = new DateTime(2023, 11, 27, 13, 26, 33, 288, DateTimeKind.Local).AddTicks(1684),
                            IsVisible = true,
                            Name = "Knowledge",
                            PostType = 0,
