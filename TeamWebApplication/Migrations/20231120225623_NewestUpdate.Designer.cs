...
namespace TeamWebApplication.Migrations
{
    ...
    [Migration("20231120225623_NewestUpdate")]
            ...
            modelBuilder.Entity("TeamWebApplication.Models.Comment", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CourseId = 10000,
                            CreationTime = new DateTime(2023, 11, 21, 0, 56, 23, 96, DateTimeKind.Local).AddTicks(9385),
                        ...
                        new
                        {
                            ...
                            CourseId = 10001,
                            CreationTime = new DateTime(2023, 11, 21, 0, 56, 23, 96, DateTimeKind.Local).AddTicks(9390),
                            UserComment = "good",
                            UserId = 20002
                        },
                        new
                        {
                            ...
                            CommentatorSurname = "Stuknaite",
                            CourseId = 10000,
                            CreationTime = new DateTime(2023, 11, 21, 0, 56, 23, 96, DateTimeKind.Local).AddTicks(9394),
                            UserComment = "Cool",
                            UserId = 20002
                        });
                });
            ...
            modelBuilder.Entity("TeamWebApplication.Models.Course", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            CourseId = 10000,
                            CreationDate = new DateTime(2023, 11, 21, 0, 56, 23, 94, DateTimeKind.Local).AddTicks(9144),
                        ...
                        {
                            CourseId = 10001,
                            CreationDate = new DateTime(2023, 11, 21, 0, 56, 23, 94, DateTimeKind.Local).AddTicks(9187),
                        ...
                        {
                            CourseId = 10002,
                            CreationDate = new DateTime(2023, 11, 21, 0, 56, 23, 94, DateTimeKind.Local).AddTicks(9189),
            ...
            modelBuilder.Entity("TeamWebApplication.Models.FilePost", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            PostId = 30003,
                            CourseId = 10001,
                            CreationDate = new DateTime(2023, 11, 21, 0, 56, 23, 96, DateTimeKind.Local).AddTicks(9355),
                            IsVisible = true,
                            Name = "File",
                            PostType = 0,
            ...
            modelBuilder.Entity("TeamWebApplication.Models.TextPost", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            PostId = 30000,
                            CourseId = 10000,
                            CreationDate = new DateTime(2023, 11, 21, 0, 56, 23, 96, DateTimeKind.Local).AddTicks(9296),
                            IsVisible = true,
                            Name = "Introduction",
                            PostType = 0,
                        ...
                        new
                        {
                            PostId = 30001,
                            CourseId = 10002,
                            CreationDate = new DateTime(2023, 11, 21, 0, 56, 23, 96, DateTimeKind.Local).AddTicks(9331),
                            IsVisible = true,
                            Name = "Knowledge",
                            PostType = 0,
